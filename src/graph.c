...
void draw_graphid_y(graph *g, double range_y_min, double range_y_max, double iter, char color){
...
void draw_graphid_x(graph *g, double range_x_min, double range_x_max, double iter, char color){
